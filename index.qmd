...
Doesn't really **showcase** the power
...
-   DRY treats the symptom of repetition
-   But the cause is expression and reasonining
-   Resolving repitition != mean a function is good
...
-   Otherwise it's building a box that you can't look inside and fix
-   Or giving people power tools without safety equipment
-   We need to teach people what happens when things go wrong
-   Teach people how to write
-   But teach people how to write but only in software that writes out to PDF so you can't edit the text ever again
...
-   Emphasise using functions to **express ideas**
    -   Avoiding repition is a symptom of needing a function
-   Demonstrate **process**
    -   Demos & writing
...
-   Look into workflow tools like [**targets**]()!
...
-   [**Closures in statistics**](https://www.stat.auckland.ac.nz/~ihaka/downloads/lexical.pdf)
-   [**youtube**](https://www.youtube.com/watch?v=J8qbRYa4430)
-   [**LISP ruined me**](https://web.archive.org/web/20201216043719/http://coding.derkeiler.com/Archive/Lisp/comp.lang.lisp/2006-04/msg01644.html)
:::
...
-   [**LISP**](https://twobithistory.org/2018/10/14/lisp.html)
-   [**something**](https://www.youtube.com/watch?v=rz3_FDVt9eg)
-   [**something**](https://www.youtube.com/watch?v=Qne86lxjgtg)
:::
:::
...
**screenshot of targets pipeline**
